	...
	<meta name="twitter:description" content="<?php echo _e(site_description()); ?>">
	<meta name="twitter:title" content="<?php echo page_title('Page can’t be found'); ?>">

	<meta name="twitter:image:src" content="<?php echo asset('content/avatar/' . staff_custom_field('avatar')); ?>"><?php else : ?>
