...
<head>
  ...
  <link rel="shortcut icon" type="image/png" href="<?php echo base_url('favicon.ico?=04102017'); ?>"/>
        ...
        <div class="navbar-collapse collapse navbar-inverse-collapse">
          ...
          <ul class="nav navbar-nav navbar-right">
	        ...
	        <?php if (is_null(Session::get('pretend'))) : ?>
	        	<a class="alert-success" href="<?php echo pretend($pretend); ?>"><span class="glyphicon glyphicon-eye-open"></span> <?php echo __('global.pretend'); ?></a>
	    	<?php else: ?>
	    		<a class="alert-warning" href="<?php echo pretend($pretend); ?>"><span class="glyphicon glyphicon-eye-close"></span> <?php echo __('global.cancel_pretend'); ?></a>
	    	<?php endif ?>
	        </li>
          	<?php endif; ?>
