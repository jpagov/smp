...
<ul class="breadcrumb" itemscope itemtype="http://schema.org/BreadcrumbList">
    ...
    <li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><span itemprop="name"><?php echo _e('site.top_management'); ?></span></li>
	...
	<li<?php if ($active) { echo ' class="active"'; } else {  echo ' itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"'; }; ?>><?php if (!$active) : ?>
