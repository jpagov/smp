...
return [
	...
	'division_slug' => 'bahagian:slug',
	'division_slug_explain' => 'Cari semua pegawai dalam bahagian tersebut. <span class="text-muted">Contoh</span>: <code>bahagian:bpm hariadi</code>',

	'branch_slug' => 'cawangan:slug',
	'branch_slug_explain' => 'Cari semua pegawai dalam cawangan tersebut',

	'sector_slug' => 'sektor:slug',
	'sector_slug_explain' => 'Cari semua pegawai dalam sektor tersebut',

	'unit_slug' => 'unit:slug',
	'unit_slug_explain' => 'Cari semua pegawai dalam unit tersebut',
