	...
	<div class="col-md-9">
		...
		<div class="tabs-top">
			...
			<ul class="nav nav-tabs" id="stafftab">
				<li<?php echo is_class_active($tab, 'profile', true); ?> role="presentation"><a href="#profile" data-toggle="tab"><?php echo __('staffs.profile'); ?></a></li>
				<li<?php echo is_class_active($tab, 'positions', true); ?> role="presentation"><a href="#positions" data-toggle="tab"><?php echo __('staffs.position'); ?></a></li>
				<?php if ($fields): ?>
					<li<?php echo is_class_active($tab, 'extend', true); ?> role="presentation"><a href="#extend" data-toggle="tab"><?php echo __('staffs.extend'); ?></a></li>
				<?php endif; ?>
				<li<?php echo is_class_active($tab, 'admin', true); ?> role="presentation"><a href="#admin" data-toggle="tab"><?php echo __('staffs.administration'); ?></a></li>

				<li<?php echo is_class_active($tab, 'staffTransfer', true); ?> role="presentation"><a href="#staffTransfer" data-toggle="tab"><?php echo __('staffs.transfer'); ?></a></li>
			</ul>
			...
			<div class="tab-content">
							...
							<div class="col-md-3 col-md-push-9">
								<div class="form-group">
									...
									<label class="control-label" for="extend_avatar">
                                        ...
                                        ?>
										<img src="<?php echo avatar($avatar); ?>?<?php echo strtotime($staff->updated) ?>" class="img-responsive img-thumbnail pull-left" width="130" width="170" >
									</label>
				...
				<?php if ($fields): ?>
					<div class="tab-pane <?php echo is_class_active($tab, 'extend'); ?>" id="extend">
						...
						<fieldset>
                            ...
                            if ($field->key == 'avatar' || $field->key == 'hide_avatar' || $field->key == 'hide_supervisor') {
                                continue ;
                            } ?>
								<div class="form-group">
				...
				<div role="tabpanel" class="tab-pane <?php echo is_class_active($tab, 'admin'); ?>" id="admin">
			...
			<div class="tab-pane" id="staffTransfer">
				<fieldset>
					<legend><?php echo __('staffs.transfer'); ?></legend>

					<div class="form-group">
						<label class="col-sm-2 control-label" for="transfer"><?php echo __('staffs.division'); ?></label>
						<div class="col-sm-6">
							<?php
							unset($divisions[$staff->division]);
							?>
							<?php echo Form::select('transfer', $divisions, Input::previous('transfer', $staff->transfer), [
								'class' => 'form-control',
								'id' => 'transfer',
								'aria-describedby' => 'transferBlock',
							]); ?>

						</div>
						<div class="col-sm-4">
							<button class="btn btn-success" type="button" id="btnTransfer" data-staff="<?php echo $staff->id ?>">Pindah</button>
						</div>
						<span id="transferBlock" class="help-block col-sm-6 col-md-push-2">Status pegawai akan di tukar kepada <code>Pertukaran</code> dan emel pengesahan akan dihantar kepada <abbr title="Pegawai Tadbir Bahagian">PTiB</abbr> terbabit dimana <abbr title="Pegawai Tadbir Bahagian">PTB</abbr> tersebut perlu mengesahkan pertukaran ini.</span>
					</div>
